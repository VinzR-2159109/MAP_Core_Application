...
public class SettingsRepository {
    ...
    private void _updateSettings(Settings updatedSettings) {
        ...
        settingsDAO.updateSettings(updatedSettings.getId(), updatedSettings.getGridSize(), updatedSettings.getEnabledAssistanceSystemsAsString(), updatedSettings.getNecessaryQOW(), updatedSettings.getVideoEnlargementFactor(), updatedSettings.getXLEDLength(), updatedSettings.getYLEDLength(), updatedSettings.getStaticBrightness(), updatedSettings.isAssemblyAssistanceEnabled());
    }
