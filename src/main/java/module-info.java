module be.uhasselt.dwi_application {
    ...
    opens be.uhasselt.dwi_application.controller.WorkInstruction to javafx.fxml;
    ...
    exports be.uhasselt.dwi_application.controller.WorkInstruction to javafx.fxml;
